...
export default function LoginPage() {
  return (
    <main className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      <section className="relative hidden md:flex items-center justify-center bg-[#2F6C66] text-white overflow-hidden">
        <div className="absolute -top-28 -right-20 h-96 w-96 rounded-full bg-white/8" />
        <div className="absolute -bottom-24 -left-24 h-[22rem] w-[22rem] rounded-full bg-white/8" />
        <div className="z-10 max-w-md text-center px-8">
          <div className="mx-auto mb-7 h-12 w-12 rounded-sm border border-white/20 bg-[#FFF3C4] flex items-center justify-center text-[#2F6C66] text-lg">
            🌴
          </div>
        ...
        <div className="w-full max-w-[420px] px-6 md:px-8">
          ...
          <form className="mt-8 space-y-5">
            <div>
              ...
              <div className="mt-2 flex items-center rounded-md border border-[#E3E6EA] bg-white shadow-sm focus-within:border-[#D5DAE0]">
            ...
            <button
              type="submit"
              className="w-full rounded-md bg-[#F0AE3F] hover:bg-[#E8A63A] py-2.5 text-white font-medium shadow-sm"
            >
              Sign In
            </button>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center gap-2 rounded-md border border-[#E3E6EA] bg-white py-2.5 text-sm"
              >
